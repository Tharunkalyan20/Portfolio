    ...
    >
      ...
      <nav className="fixed left-0 top-0 h-full w-16 md:w-20 z-40 flex flex-col items-center justify-between py-4 md:py-8">
        ...
        <div className="flex flex-col space-y-4">
          <a
            href="https://github.com/Tharunkalyan20"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/tharunkalyan-padabakkala-37b5022bb/"
            target="_blank"
            rel="noopener noreferrer"
            className={`p-2 transition-all duration-300 hover:scale-110 hover:rotate-12 ${
              isDarkMode ? "text-gray-400 hover:text-white" : "text-gray-600 hover:text-black"
        ...
        <div className="relative w-64 h-72 md:w-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl">
          ...
          />
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 pt-8">
                ...
                >
                  <a href="/Tharun_Resume.pdf" download="Tharun_Resume.pdf">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
              {[
                ...
                {
                  title: "Potato Plant Leaf Disease Detection and Classification",
                  description:
                    "This project presents a deep learning-based system using Efficient NetB0 to accurately detect and classify potato leaf diseases, achieving high performance through image augmentation and GPU- accelerated training. Deployed as a Streamlit web app, it offers real-time predictions and actionable insights, aiding sustainable farming and crop yield improvement.",
                  tech: ["CNN", "Deep Learning", "Neural Networks"],
                  year: "2025",
                  status: "Live",
                },
              ].map((project, index) => (
                ...
                >
                  ...
                  >
                    <CardContent className="p-8">
                      ...
                      >
                        <a href="https://github.com/Tharunkalyan20" target="_blank" rel="noopener noreferrer">
                          View Project
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-900/50" : "bg-gray-50"}`}>
                      ...
                      <p className={`text-sm ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>CGPA: 7.78/10.0</p>
                    </div>
                    <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-900/50" : "bg-gray-50"}`}>
                      <h4 className="font-medium">Intermediate</h4>
                      <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Sri Chaitanya Junior College (94%)</p>
                    </div>
                  </div>
                </div>
                ...
                {[
                  {
                    icon: Mail,
                    label: "Email",
                    value: "tharunkalyanpadabakkala@gmail.com",
                    href: "mailto:tharunkalyanpadabakkala@gmail.com",
                  },
                  { icon: Phone, label: "Phone", value: "+91 7207079527", href: "tel:+917207079527" },
